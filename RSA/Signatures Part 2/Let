#Chuyển đổi bí mật được trả về thành chuỗi bytes và lưu trữ nó trong biến s1, S2, S3
...
#---------------------------------------------------------------------------------------------
#Sau khi tính toán được tất cả các bí mật, chúng ta có thể giải mã cờ ban đầu bằng cách sử dụng phép XOR để kết hợp tất cả các bí mật.
